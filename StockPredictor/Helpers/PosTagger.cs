...

    {
        ...
        public void nounPhrase(string article, string fileName)
        {
           ...
           // posPhrasePercentage, negPhrasePercentage);
            ...
            string newFileName = fileName + "Noun";
            em.saveDataToExcel(newFileName, "Noun", elapsedMs.ToString(), wordCount, sentenceCount, posWordCount, negWordCount,
          posWordPercentage, negWordPercentage,
           positivePhraseCount, negativePhraseCount,
           posPhrasePercentage, negPhrasePercentage);
        }//end class
...
//--------------------------------------------named entites---------------------------------------------------------------///
        ...
        public void nameEntites(string article, string fileName)
        {
           ...
           // posPhrasePercentage, negPhrasePercentage);
            //add the data to special excel file for only this specific out put for this stock
            string newFileName = fileName + "Named";
            em.saveDataToExcel(newFileName, "Named", elapsedMs.ToString(), wordCount, sentenceCount, posWordCount, negWordCount,
          posWordPercentage, negWordPercentage,
           positivePhraseCount, negativePhraseCount,
           posPhrasePercentage, negPhrasePercentage);
        }//end method 
